<nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
    <a href="../view/index.php" class="navbar-brand d-flex d-lg-none me-4">
    ...
    <div class="navbar-nav align-items-center ms-auto">
        ...
        if (isset($_SESSION["email"])) {
            ...
            echo '  <a href="../view/logout_page.php" class="dropdown-item">Log Out</a>';
            echo '</div>';
            echo '</div>';
        }else{
            echo '<div class="nav-item dropdown">';
            echo '<a href="../view/signin.php" class="nav-link">';
            echo '  <img class="rounded-circle me-lg-2" src="../view/img/user.jpg" alt="" style="width: 40px; height: 40px;">';
