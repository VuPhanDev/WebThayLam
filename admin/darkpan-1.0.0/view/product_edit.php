                    ...
                    <div class="col-12 col-xl-7">
                        <div class="col-sm-12 ">
                            <div class="bg-secondary rounded h-100 p-4">
                                <h6 class="mb-4" style="text-align: center;">Chi tiết sản phẩm</h6>
                                ...
                                <form action="../controller/productController.php" method="post">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select mb-3" name="switch_status" id="switch_status" required>
                                                <option value="'.<?php $data["status"] ?>.'" hidden><?php echo $data["status"] == 1 ? "Hoạt động" : "Ngưng hoạt động" ?></option>
                                    ...
                                    <div class="row mb-3">
                                        <label for="txt_name" class="col-sm-2 col-form-label">Mã sản phẩm</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" readonly value="<?php echo $data["productID"] ?>" name="txt_id" id="txt_id">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="txt_name" class="col-sm-2 col-form-label">Tên sản phẩm</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="<?php echo $data["productName"] ?>" name="txt_name" id="txt_name">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="txt_price" class="col-sm-2 col-form-label">Giá bán</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="<?php echo $data["price"] ?>" name="txt_price" id="txt_price">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="txt_amount" class="col-sm-2 col-form-label">Số lượng</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="<?php echo $data["amount"] ?>" name="txt_amount" id="txt_amount">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="txt_description" class="col-sm-2 col-form-label">Mô tả</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="<?php echo $data["description"] ?>" name="txt_description" id="txt_description">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <?php echo ' <img src="../view/img/product/' . $data["image"] .'" alt="" width="135" style="margin-top: 10px; margin-left: 10px;" >'; ?>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select mb-3" name="txt_catID" id="txt_catID" required>
                                                <option value="'.<?php $data["catID"] ?>.'" hidden><?php 
                                                switch($data["catID"]){
                                                    case "1":echo "Áo";
                                                    break;
                                                    case "2":echo "Quần";
                                    ...
                                    <button type="submit" class="btn btn-outline-success m-2" name="product_action" value="product_update">Cập nhập</button>
                                </form>                           
                            </div>
                        </div>
                    </div>
