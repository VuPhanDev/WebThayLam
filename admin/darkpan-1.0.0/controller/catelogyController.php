...
include_once '../model/cateloryModel.php';
include_once './BaseController.php';

class CatelogyController extends BaseController
{
...
if (count($_POST) > 0) {
    $catelory_action = $_POST["catelory_action"];
} else if (count($_GET) > 0) {
    $catelory_action = $_GET["action"];
}
$cateloryController = new CatelogyController($catelory_action);
